...
class AddDepartmentScreen extends ConsumerStatefulWidget {
  ...
  final String? inputCollegeId;

  const AddDepartmentScreen({super.key, this.department, this.inputCollegeId});
...
class _AddDepartmentScreenState extends ConsumerState<AddDepartmentScreen> {
  ...
  void initState() {
    ...
    _nameArController = TextEditingController(text: widget.department?.nameAr);
    _descEnController = TextEditingController(
      text: widget.department?.descriptionEn,
    );
    _descArController = TextEditingController(
      text: widget.department?.descriptionAr,
    );
    _imageUrlController = TextEditingController(
      text: widget.department?.imageUrl,
    );

    _selectedCollegeId = widget.department?.collegeId ?? widget.inputCollegeId;
    _loadColleges();
  }
  ...
  Future<void> _handleSave() async {
    ...
    if (_selectedCollegeId == null) {
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(
          content: Text('Please select a parent college.'),
    ...
    try {
      ...
      if (widget.department == null) {
        ...
        await repo.updateDepartment(widget.department!.id, data);
      }
  ...
  Widget _buildCollegeSelector(Color primaryColor) {
    ...
    return Container(
      ...
      child: DropdownButtonHideUnderline(
        child: DropdownButton<String>(
          ...
          icon: Icon(LucideIcons.chevronDown, color: primaryColor),
              ...
              delegate: SliverChildListDelegate([
                Form(
                  ...
                  child: Column(
                    ...
                    children: [
                      _buildSectionHeader(
                        'Parent College Assignment',
                        LucideIcons.building,
                        Colors.amberAccent,
                      ),
                      const SizedBox(height: 16),
                      _buildCollegeSelector(primaryColor)
                          .animate()
                          .fadeIn(delay: 50.ms)
                      ...
                      const SizedBox(height: 14),
                      _buildPremiumField(
                            label: 'Department Logo URL (Optional)',
