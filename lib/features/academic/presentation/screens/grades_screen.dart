        ...
        SliverPadding(
          ...
          sliver: SliverList(
            delegate: SliverChildBuilderDelegate((context, index) {
              final courses = [
                {
                  'name': t.attendance.subjects.ai,
                  'grade': 'A',
                  'points': '4.0',
                },
                {
                  'name': t.attendance.subjects.calculus,
                  'grade': 'A-',
                  'points': '3.7',
                },
                {
                  'name': t.attendance.subjects.ethics,
                  'grade': 'B+',
                  'points': '3.3',
                },
              ];
  ...
  Widget _buildGradeSummary(BuildContext context, bool isGlass, bool isArabic) {
    final content = Padding(
      ...
      child: Row(
        ...
        children: [
          _buildSummaryStat(context, '3.92', t.grades.cumulative_gpa, isGlass),
          Container(
            width: 1,
            height: 40,
            color: isGlass ? Colors.white10 : Colors.black12,
          ),
          _buildSummaryStat(context, '9', t.grades.credits, isGlass),
        ],
      ),
    );
          ...
          Expanded(
            child: Column(
              ...
              children: [
                ...
                Text(
                  '${t.grades.grade_point}: ${course['points']}',
                  style: GoogleFonts.inter(
                    fontSize: 12,
