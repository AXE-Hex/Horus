...
class _TranslationsOnboardingFacultiesDirectoryAr implements TranslationsOnboardingFacultiesDirectoryEn {
	...
	@override String get subtitle => 'استكشف تخصصاتنا الأكاديمية المتنوعة';
}
...
class _TranslationsDashboardLabelsAr implements TranslationsDashboardLabelsEn {
	...
	// Translations
	@override String get university_name => 'جامعة هيو';
...
class _TranslationsAcademicProgressCategoriesAr implements TranslationsAcademicProgressCategoriesEn {
	...
	// Translations
	@override String get university => 'متطلبات الجامعة';
...
class _TranslationsProfessorManageAr implements TranslationsProfessorManageEn {
	_TranslationsProfessorManageAr._(this._root);
...
extension on TranslationsAr {
	dynamic _flatMapFunction(String path) {
		return switch (path) {
			...
			'onboarding.faculties_directory.subtitle' => 'استكشف تخصصاتنا الأكاديمية المتنوعة',
			...
			'dashboard.labels.university_name' => 'جامعة هيو',
			...
			'academic_progress.categories.university' => 'متطلبات الجامعة',
