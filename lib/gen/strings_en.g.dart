...
class TranslationsProfessorEn {
	...
	String get dashboard => 'Professor Dashboard';
	...
	late final TranslationsProfessorManageEn manage = TranslationsProfessorManageEn._(_root);
...
class TranslationsOnboardingFacultiesDirectoryEn {
	...
	/// en: 'Explore our diverse academic departments'
	String get subtitle => 'Explore our diverse academic departments';
}
...
class TranslationsDashboardLabelsEn {
	...
	/// en: 'UNIVERSITY OF HUE'
	String get university_name => 'UNIVERSITY OF HUE';
...
class TranslationsAcademicProgressCategoriesEn {
	...
	String get university => 'University Requirements';
...
class TranslationsProfessorQuickActionsEn {
	...
	/// en: 'Action clicked'
	String get action_clicked => 'Action clicked';
}

// Path: professor.manage
class TranslationsProfessorManageEn {
	TranslationsProfessorManageEn._(this._root);
	...
	/// en: 'Active TAs'
	String get active_tas => 'Active TAs';

	/// en: 'Student Groups'
	String get student_groups => 'Student Groups';
	...
	/// en: 'Weekly Slots'
	String get weekly_slots => 'Weekly Slots';
}
...
class TranslationsProfessorProfileEn {
	...
	/// en: 'Office Hour'
	String get office_hour => 'Office Hour';
...
extension on Translations {
	dynamic _flatMapFunction(String path) {
		return switch (path) {
			...
			'onboarding.faculties_directory.subtitle' => 'Explore our diverse academic departments',
			...
			'dashboard.labels.university_name' => 'UNIVERSITY OF HUE',
			...
			'academic_progress.categories.university' => 'University Requirements',
			...
			'schedule.no_lectures' => 'No lectures found',
			...
			'professor.welcome_back' => 'Welcome back',
			...
			'professor.quick_actions.action_clicked' => 'Action clicked',
			'professor.manage.manage_tas' => 'Manage TAs',
			'professor.manage.active_tas' => 'Active TAs',
			'professor.manage.student_groups' => 'Student Groups',
			'professor.manage.total_students' => 'Total Students',
			'professor.manage.shared_files' => 'Shared Files',
			'professor.manage.uploaded_files' => 'Uploaded Files',
			'professor.manage.office_hours' => 'Office Hours',
			'professor.manage.weekly_slots' => 'Weekly Slots',
			'professor.profile.office_hour' => 'Office Hour',
			'professor.profile.urgent_announcements' => 'Urgent Announcements',
			'professor.profile.teaching_assistants' => 'Teaching Assistants',
			'professor.profile.student_groups' => 'Student Groups',
			'professor.profile.students' => 'Students',
			'professor.profile.join' => 'Join',
			'professor.profile.joined' => 'Joined',
			'professor.profile.shared_resources' => 'Shared Resources',
			'professor.profile.office_hours' => 'Office Hours',
			'professor.profile.walk_in' => 'Walk-in',
			_ => null,
		};
	}
}
