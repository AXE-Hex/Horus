...
class Translations with BaseTranslations<AppLocale, Translations> {
	...
	late final TranslationsExtractedEn extracted = TranslationsExtractedEn._(_root);
}
...
class TranslationsExtractedEn {
	...
	String get write_something_about_yourself => 'Write something about yourself...';
	...
	/// en: 'Update your personal info and photo'
	String get update_your_personal_info_and_photo => 'Update your personal info and photo';

	/// en: 'Password Recovery'
	String get password_recovery => 'Password Recovery';

	/// en: 'Send password recovery link to your email'
	String get send_password_recovery_link_to_your_emai => 'Send password recovery link to your email';

	/// en: 'Dark Mode'
	String get dark_mode => 'Dark Mode';

	/// en: 'Toggle between dark and light mode'
	String get toggle_between_dark_and_light_mode => 'Toggle between dark and light mode';
	...
	/// en: 'Disable complex visual effects'
	...
	/// en: 'Get help and resolve any issues'
	String get get_help_and_resolve_any_issues => 'Get help and resolve any issues';
	...
	/// en: 'Version details and developer info'
	String get version_details_and_developer_info => 'Version details and developer info';
	...
	/// en: 'Your opinion helps us improve'
	...
	/// en: '✅ Thank you! Feedback submitted.'
	...
	/// en: 'No faculty members assigned'
	...
	/// en: 'No custom roles yet'
	String get no_custom_roles_yet => 'No custom roles yet';

	/// en: 'Create a new role or merge two roles'
	String get create_a_new_role_or_merge_two_roles => 'Create a new role or merge two roles';
	...
	/// en: 'Could not load custom roles'
	String get could_not_load_custom_roles => 'Could not load custom roles';

	/// en: 'Make sure "roles" table exists in Supabase'
	String get make_sure_roles_table_exists_in_supabase => 'Make sure "roles" table exists in Supabase';
	...
	/// en: 'Select two roles to combine their permissions'
	String get select_two_roles_to_combine_their_permis => 'Select two roles to combine their permissions';
	...
	/// en: 'User identity has been verified'
	String get user_identity_has_been_verified => 'User identity has been verified';

	/// en: 'Identity not yet verified'
...
extension on Translations {
	dynamic _flatMapFunction(String path) {
		return switch (path) {
			...
			'extracted.write_something_about_yourself' => 'Write something about yourself...',
			...
			'extracted.update_your_personal_info_and_photo' => 'Update your personal info and photo',
			'extracted.password_recovery' => 'Password Recovery',
			'extracted.send_password_recovery_link_to_your_emai' => 'Send password recovery link to your email',
			'extracted.dark_mode' => 'Dark Mode',
			'extracted.toggle_between_dark_and_light_mode' => 'Toggle between dark and light mode',
			...
			'extracted.disable_complex_visual_effects' => 'Disable complex visual effects',
			...
			'extracted.view_all_your_notifications' => 'View all your notifications',
			...
			'extracted.version_details_and_developer_info' => 'Version details and developer info',
			'extracted.privacy_policy' => 'Privacy Policy',
			'extracted.terms_and_rules_for_data_usage' => 'Terms and rules for data usage',
			...
			'extracted.your_opinion_helps_us_improve' => 'Your opinion helps us improve',
			'extracted.write_your_feedback_here' => 'Write your feedback here...',
			'extracted.thank_you_feedback_submitted' => '✅ Thank you! Feedback submitted.',
			...
			'extracted.create_a_new_role_or_merge_two_roles' => 'Create a new role or merge two roles',
			'extracted.create' => 'Create',
			'extracted.merge' => 'Merge',
			'extracted.could_not_load_custom_roles' => 'Could not load custom roles',
			'extracted.make_sure_roles_table_exists_in_supabase' => 'Make sure "roles" table exists in Supabase',
			...
			'extracted.select_two_roles_to_combine_their_permis' => 'Select two roles to combine their permissions',
			...
			'extracted.merged_permissions_preview' => 'Merged Permissions Preview',
			...
			'extracted.user_identity_has_been_verified' => 'User identity has been verified',
			...
			'extracted.user_cannot_access_the_system' => 'User cannot access the system',
