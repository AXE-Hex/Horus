...
class Translations with BaseTranslations<AppLocale, Translations> {
  ...
  late final TranslationsWelcomeEn welcome = TranslationsWelcomeEn.internal(
    _root,
  );
  ...
  late final TranslationsDashboardEn dashboard =
      TranslationsDashboardEn.internal(_root);
  late final TranslationsSettingsEn settings = TranslationsSettingsEn.internal(
    _root,
  );
  late final TranslationsCollegesEn colleges = TranslationsCollegesEn.internal(
    _root,
  );
  late final TranslationsTranscriptEn transcript =
      TranslationsTranscriptEn.internal(_root);
  late final TranslationsAcademicProgressEn academic_progress =
      TranslationsAcademicProgressEn.internal(_root);
  ...
  late final TranslationsSubjectResultsEn subject_results =
      TranslationsSubjectResultsEn.internal(_root);
  late final TranslationsActionPlanEn action_plan =
      TranslationsActionPlanEn.internal(_root);
  late final TranslationsCoursesEn courses = TranslationsCoursesEn.internal(
    _root,
  );
  late final TranslationsScheduleEn schedule = TranslationsScheduleEn.internal(
    _root,
  );
  late final TranslationsExamScheduleEn exam_schedule =
      TranslationsExamScheduleEn.internal(_root);
  late final TranslationsAttendanceEn attendance =
      TranslationsAttendanceEn.internal(_root);
  late final TranslationsRegistrationEn registration =
      TranslationsRegistrationEn.internal(_root);
  late final TranslationsPaymentEn payment = TranslationsPaymentEn.internal(
    _root,
  );
  late final TranslationsInvoicesEn invoices = TranslationsInvoicesEn.internal(
    _root,
  );
  late final TranslationsNotificationsEn notifications =
      TranslationsNotificationsEn.internal(_root);
  late final TranslationsSupportEn support = TranslationsSupportEn.internal(
    _root,
  );
  late final TranslationsSecurityEn security = TranslationsSecurityEn.internal(
    _root,
  );
  late final TranslationsTutorialsEn tutorials =
      TranslationsTutorialsEn.internal(_root);
  ...
  late final TranslationsAdministrationEn administration =
      TranslationsAdministrationEn.internal(_root);
  late final TranslationsProfessorEn professor =
      TranslationsProfessorEn.internal(_root);
  late final TranslationsRolesEn roles = TranslationsRolesEn.internal(_root);
  late final TranslationsAcademicEn academic = TranslationsAcademicEn.internal(
    _root,
  );
  late final TranslationsAdminEn admin = TranslationsAdminEn.internal(_root);
  late final TranslationsEnrollmentEn enrollment =
      TranslationsEnrollmentEn.internal(_root);
  late final TranslationsSharedEn shared = TranslationsSharedEn.internal(_root);
  late final TranslationsStudentsEn students = TranslationsStudentsEn.internal(
    _root,
  );
  late final TranslationsExtractedEn extracted =
      TranslationsExtractedEn.internal(_root);
}
...
class TranslationsOnboardingEn {
  ...
  late final TranslationsOnboardingLanguageEn language =
      TranslationsOnboardingLanguageEn.internal(_root);
  ...
  late final TranslationsOnboardingFacultiesDirectoryEn faculties_directory =
      TranslationsOnboardingFacultiesDirectoryEn.internal(_root);
  late final TranslationsOnboardingStyleEn style =
      TranslationsOnboardingStyleEn.internal(_root);
  late final TranslationsOnboardingThemeEn theme =
      TranslationsOnboardingThemeEn.internal(_root);
}
...
class TranslationsAuthEn {
  ...
  late final TranslationsAuthLoginEn login = TranslationsAuthLoginEn.internal(
    _root,
  );
...
class TranslationsDashboardEn {
  ...
  late final TranslationsDashboardIdCardEn id_card =
      TranslationsDashboardIdCardEn.internal(_root);
  late final TranslationsDashboardSectionsEn sections =
      TranslationsDashboardSectionsEn.internal(_root);
  late final TranslationsDashboardItemsEn items =
      TranslationsDashboardItemsEn.internal(_root);
  late final TranslationsDashboardLabelsEn labels =
      TranslationsDashboardLabelsEn.internal(_root);
}
...
class TranslationsSettingsEn {
  ...
  late final TranslationsSettingsSectionsEn sections =
      TranslationsSettingsSectionsEn.internal(_root);
  late final TranslationsSettingsTilesEn tiles =
      TranslationsSettingsTilesEn.internal(_root);
  late final TranslationsSettingsMessagesEn messages =
      TranslationsSettingsMessagesEn.internal(_root);
...
class TranslationsCollegesEn {
  ...
  late final TranslationsCollegesDetailsEn details =
      TranslationsCollegesDetailsEn.internal(_root);
  ...
  late final TranslationsCollegesDepartmentsEn departments =
      TranslationsCollegesDepartmentsEn.internal(_root);
}
...
class TranslationsTranscriptEn {
  ...
  late final TranslationsTranscriptOverviewEn overview =
      TranslationsTranscriptOverviewEn.internal(_root);
  late final TranslationsTranscriptSemesterEn semester =
      TranslationsTranscriptSemesterEn.internal(_root);
  late final TranslationsTranscriptCourseEn course =
      TranslationsTranscriptCourseEn.internal(_root);
}
...
class TranslationsAcademicProgressEn {
  ...
  late final TranslationsAcademicProgressCategoriesEn categories =
      TranslationsAcademicProgressCategoriesEn.internal(_root);
  late final TranslationsAcademicProgressStatusEn status =
      TranslationsAcademicProgressStatusEn.internal(_root);
}
...
class TranslationsAttendanceEn {
  ...
  late final TranslationsAttendanceSubjectsEn subjects =
      TranslationsAttendanceSubjectsEn.internal(_root);
}
...
class TranslationsAdministrationEn {
  ...
  late final TranslationsAdministrationAuditLogsEn audit_logs =
      TranslationsAdministrationAuditLogsEn.internal(_root);
}
...
class TranslationsProfessorEn {
  ...
  late final TranslationsProfessorStatsEn stats =
      TranslationsProfessorStatsEn.internal(_root);
  late final TranslationsProfessorQuickActionsEn quick_actions =
      TranslationsProfessorQuickActionsEn.internal(_root);
  late final TranslationsProfessorProfileEn profile =
      TranslationsProfessorProfileEn.internal(_root);
}
...
class TranslationsRolesEn {
  ...
  late final TranslationsRolesCategoriesEn categories =
      TranslationsRolesCategoriesEn.internal(_root);
  late final TranslationsRolesNamesEn names = TranslationsRolesNamesEn.internal(
    _root,
  );
  late final TranslationsRolesDescriptionsEn descriptions =
      TranslationsRolesDescriptionsEn.internal(_root);
}
...
class TranslationsExtractedEn {
  TranslationsExtractedEn.internal(this._root);
...
class TranslationsOnboardingStyleEn {
  ...
  late final TranslationsOnboardingStyleClassicEn classic =
      TranslationsOnboardingStyleClassicEn.internal(_root);
  late final TranslationsOnboardingStyleGlassEn glass =
      TranslationsOnboardingStyleGlassEn.internal(_root);
}
...
class TranslationsTranscriptCourseEn {
  ...
  late final TranslationsTranscriptCourseStatusEn status =
      TranslationsTranscriptCourseStatusEn.internal(_root);
}
...
class TranslationsAdministrationAuditLogsEn {
  ...
  late final TranslationsAdministrationAuditLogsTabsEn tabs =
      TranslationsAdministrationAuditLogsTabsEn.internal(_root);
  late final TranslationsAdministrationAuditLogsLabelsEn labels =
      TranslationsAdministrationAuditLogsLabelsEn.internal(_root);
}
